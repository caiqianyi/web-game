...
public interface ILotteryService {
	 ...
	 * @return 返回领取的记录
	 */
	LotteryToken gainToken(Integer userId);
	 ...
	 * @return
	 */
	List<LotteryToken> buyGainToken(Integer userId,Integer count);
	 ...
	 * @return
	 */
	List<LotteryToken> findLotteryByHandle(Integer userId,String handle);
